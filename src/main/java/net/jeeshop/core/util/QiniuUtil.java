...
public class QiniuUtil {
	...
	// 要上传的空间
	private static String bucketname = "jshop"; // 对应要上传到七牛上 你的那个路径（自己建文件夹 注意设置公开）  
	// 七牛访问前缀
	private static String url = "http://opjmh3457.bkt.clouddn.com/";
	...
	private static Auth authInstance() {
        ...
        String accesskey = "aOn_aFElbDwp8UoymHSBAiY8e8oSi0DNuaDxDfjg";
        String secretkey = "oy3MzCLSWOUjYKGhwSznlOC4NnKIHF89ZNe2_2A5";
        // 密钥配置
	...
	public static void main(String[] args) throws IOException {
		...
		// 上传到七牛后保存的文件名
		String key = "attached/image/20140304/1393901989351_1.jpg";
		// 上传文件的路径  
		String filePath = "D:\\jshop\\attached\\image\\20140304\\1393901989351_1.jpg"; // 本地要上传文件路径   
